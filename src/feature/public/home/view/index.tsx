...
export default function Page() {
  return (
    <div className="min-h-svh bg-background text-foreground">
      <div className="flex flex-col px-4 sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto">
        <main>
          ...
          <section id="features" className="py-16">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-base text-muted-foreground">
                Align planning, delivery, and learning with tools that make clarity feel effortless.
              </p>
            </div>
        ...
        <footer className="border-t border-border bg-background">
          <div className="flex gap-6 py-10 flex-col sm:flex-row items-center justify-center sm:justify-between">
            <div className="flex items-center gap-3 text-sm font-semibold">
              <span className="hidden sm:flex size-8 items-center justify-center rounded-full bg-primary text-primary-foreground">
